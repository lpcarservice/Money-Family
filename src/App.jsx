...
const EXPENSE_CATS = ['อาหาร', 'ค่ากาแฟ', '7-11', 'ที่อยู่อาศัย', 'ค่าน้ำ', 'ค่าไฟ', 'ค่ารีดผ้า', 'เดินทาง', 'ผ่อนชำระ', 'สุขภาพ', 'บันเทิง', 'การศึกษา', 'ของใช้ส่วนตัว', 'unfiled', 'ปาร์ตี้', 'อื่นๆ'];
